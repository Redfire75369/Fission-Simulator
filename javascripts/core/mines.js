const mineUpgradeCosts = [new Decimal("5e8"), new Decimal("2e10"), new Decimal("1e19"), new Decimal("1e24"), new Decimal("1e38"), new Decimal("1e51"), new Decimal("1e64"), new Decimal("1e80")];
