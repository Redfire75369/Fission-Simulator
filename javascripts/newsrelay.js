...
const newsArray = [
	...
	["Disclaimer: Redfire Corp. (we, us, our company, redfire, redfire corp.) is in no way responsible or accountable for any consequences caused through the use of Redfire Corp. products. These consequences may include, but are not limited to, sudden reality destabilisation, time warping, molecular instability, and instant death.", true],
