...
function AchievementComponent(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "flex-col align horizontal-center tooltip " + (completed ? "achcomplete" : "achlocked")
  }, /*#__PURE__*/React.createElement("img", {
    src: "resources/images/achievements/" + props.id + ".png"
  }), /*#__PURE__*/React.createElement("span", {
    className: "tooltiptext"
  }, achievementTexts[props.id].split("\n")[0], /*#__PURE__*/React.createElement("br", null), achievementTexts[props.id].split("\n")[1]));
}