class ProductionNavigationSubtabButton extends ReactStateComponent {
	...
	render() {
		return (
			<button onClick={this.showProductionTab.bind(this)} className={this.state.active ? "navigation--active" : ""} style={{display: this.state.unlocked ? "" : "none"}}>{this.props.text}</button>
		);
	}
}
